...
export default function Faq(props) {
  ...
  return(
      <div className={classes.aboutContainer}>
        ...
        <p className={classes.aboutContainer}><b>EaseMyFlight</b> is a travel correlation web portal that gives you a chance to discover cheap flights tickets on the web.
        ...
        <p className={classes.aboutContainer}> Going inside a specific budget plan isn't just important yet additionally fundamental for you to capitalize on your vacation.
        ...
        <p className={classes.aboutContainer}> We take off aggressive costs on flight tickets, from probably the most confided companies. We offer you energizing deals to commence your get-away with the goal that it doesn't put an opening in your pocket.
          You can rest guaranteed that you are getting the best flight deal alongside value reserve funds.</p>
        <p className={classes.aboutContainer}> As yet asking why you should book with us? We have a smooth and hassle free reserving procedure that can provide you with astonishing travel deals.
